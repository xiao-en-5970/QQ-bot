...
5. **图片归属 / 图文交杂多商品**（输入是用户在 60s 内的连续发言整段）:
   ...
   bot 已经把"这位用户从开始发言到沉默 300s 之间的所有消息"按时间顺序排好喂给你。
   ...
   **配对策略**：按"出现顺序号"对齐——商品文字按出现顺序编号 t1..tN，图片按
   ...
   3. **description**：把每条记录里的**原始文字**按出现顺序拼起来——**每件商品独占
      一行**，行尾用中文句号"。"结尾；不同商品之间用**换行符 \n 分隔**（不要用
      顿号、不要挤在一行）。便于用户在 app 详情页查看完整明细，包括每件物品的具体价格。
   ...
   **正确输出**（**只** 1 个 publish_good）：
     {
       ...
       "description": "不规则大花瓶，一个4块钱。\n小喷壶，1块钱。\n两用雨衣，3块钱。\n防撞条全新两米长，2块钱。\n防尘膜全新一卷，2块钱。\n粉色衣服收纳盒，表面有点脏挺大的，1块钱。\n狼人杀卡牌，2块钱。\n可撕拉指甲油，用过一次，两瓶3块钱。\n得力热熔枪，送胶棒，10块钱。",
       "negotiable": true,
       "category": 1,
       "is_batch": true,
